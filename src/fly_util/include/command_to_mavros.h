...
namespace namespace_command_to_mavros
{
  ...
  void command_to_mavros::autoland()
  {
    cout << "autoland successfully!" << endl;

    if (current_state.mode == "OFFBOARD")
    {
      mode_cmd.request.custom_mode = "AUTO.LAND";
      set_mode_client.call(mode_cmd);
      cout << "autolandautolandautoland successfully!" << endl;
    }
  ...
  void command_to_mavros::land()
  {
    ...
    {
      cout << "autoland2 successfully!" << endl;
      if (current_state.mode == "OFFBOARD")
      {
        cout << "autoland 3successfully!" << endl;
        mode_cmd.request.custom_mode = "AUTO.LAND";
        set_mode_client.call(mode_cmd);
      }
